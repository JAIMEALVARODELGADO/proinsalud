...
include('php/funciones.php');
        ...
        if(!empty($tipo_terapia)){$condicion3=$condicion3."tipoterapia_this='".$tipo_terapia."' AND ";}
        ...
        SELECT '' AS iden_tcon,th.iden_this ,DATE(th.fecha_this) AS fecha,th.numero_orden_this, 
            ...
            th.tipoterapia_this,t.nomb_des AS tipo_terapia
