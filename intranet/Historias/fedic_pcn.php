...
<form name="form1" method="POST" action="cons_cronicos.php" target='fr02'>
<body>
 <table class="Tbl0">
   <tr><td class='Td1' align='center'>Historia de Enfemeria Paciente Cronico</td></tr>
 </table>
 <center>
 <?
	...
	echo "<br>
			...
			<th class='Th0' align='left'  width='5%'><b><input type=text name=cod_usu size=14></td>
