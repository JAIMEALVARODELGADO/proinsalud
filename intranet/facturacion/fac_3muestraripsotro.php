...
<?
  ...
  while($rowcon=mysql_fetch_array($consultacon)){
    ...
    echo "<td class='Td2' align='center'><input type='text' name='$nomvar' size='15' maxlength='15' value='$rowcon[fechasuministrotecnologia]' disabled></td>";
    ...
    echo "<td class='Td2' align='center'><input type='text' name='$nomvar' size='65' maxlength='60' value='$rowcon[nomtecnologia]' disabled></td>";

    $nomvar="cantidados".$cont;
    echo "<td class='Td2' align='center'><input type='text' name='$nomvar' size='4' maxlength='60' value='$rowcon[cantidados]' disabled></td>";
        
    $nomvar="vrunitos".$cont;
    echo "<td class='Td2' align='right'><input type='text' name='$nomvar' size='7' maxlength='7' value='".number_format($rowcon[vrunitos])."' disabled></td>";
