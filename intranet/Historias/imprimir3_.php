...
WHERE  detalle_labs.nord_dlab='$nd_' AND detalle_labs.iden_labs='$iden_labs' AND detalle_labs.estd_dlab<>'EL'");
...
if(mysql_num_rows($conotrex)<>0)
{
	...
	{	
		...
		if($cod_loex=='904107')
		{
			...
			$fila=increm($fila+2,$pdf,$cod,$nd_);
			$pdf->SetXY(80,$fila);
			$pdf->Cell(40,5,"HORMONA FOLÍCULO ESTIMULANTE - LSH",0);
