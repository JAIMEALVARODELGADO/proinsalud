...
<?php
  ...
  while($rowcon=mysql_fetch_array($consultacon)){    
    ...
    echo "<td class='Td2' align='center'><b>Pri <input type='text' name='$nomvar' size='4' maxlength='4' value='$rowcon[coddiagnosticoprincipal]' disabled><a href='#'  onclick='ayuda(\"D\",\"$rowcon[coddiagnosticoprincipal]\")'><img src='icons/feed_magnify.png' width='15' height='15'></a>";
