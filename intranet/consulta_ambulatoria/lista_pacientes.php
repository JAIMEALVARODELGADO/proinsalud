...
<?PHP	
	...
	if ($Gareanh=="01") //MEDICINA GENERAL
	{
		...
		ORDER BY horarios.Fecha_horario DESC , horarios.Hora_horario, areas.nom_areas LIMIT 10");
	}	
...
//fin aneste
			...
			{				
				...
				if($mrsk_tri=='B102')
				{					
					echo"<B><img width=15% height=15% src='img/formatos/naranja.jpg'></B></td>";		
				}
				if($mrsk_tri=="B103")
				{
