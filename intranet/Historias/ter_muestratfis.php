...
<form name="form1" method="post" action="">
    <table class="Tbl0">
        <tr><td class='Td1' align='center'>HISTORIAL DE TERAPIA FISICA</td></tr>
    </table>
    <?php
    ...
    if(mysql_num_rows($consultausu)!=0){
        ...
        $consulta="SELECT tf.iden_this,tf.fecha_this,ser.nomb_des,med.nom_medi
            ...
            WHERE tf.codi_usu='$rowusu[codi_usu]' ORDER BY tf.iden_this";
        //echo "<br>".$consulta;
        ...
        while($row=mysql_fetch_array($consulta)){
            echo "<tr>";           
            echo "<td class='Td0' align='center'><a href='../terapia/ter_impretf.php?iden_this=$row[iden_this]' target='new' title='Mirar Historia'><img src='../terapia/img/lupa.jpg' width='20' height='20' alt='Mirar'></a></td>";
            echo "<td class='Td0' align='left'>$row[fecha_this]</td>";
