...
<?
	...
	{				
		...
		WHERE citas.Esta_cita<>'2' AND citas.Clase_citas<='5' AND horarios.Cserv_horario='$Gareanh' AND horarios.Fecha_horario<='$fecha' And horarios.Fecha_horario>='2011-05-01' AND horarios.Cmed_horario='1101'
	...
	{		
		echo"<br><br><br><table align=center class='tbl' width=95%>		
		<tr>
		...
		{			
			...
			if($espe!='2656')
			{
				...
				{				
					...
					if($idcitaant=='NOHABIL' && $ocupa=='NO' && $descestdocita=='ESPERA')
					{
						if($clasitri=="1")
						{					
							echo"<td align=center><a href='#'><img src='imagenes/next_rojo.jpg' border=0></a></td>";
						}
						else if($clasitri=="2")
						{					
							echo"<td align=center><a href='#'><img src='imagenes/next_naran.jpg' border=0></a></td>";
						}
						else
						{					
							echo"<td align=center><a href='#'><img src='imagenes/next.jpg' border=0></a></td>";
						}
						$idcitaant='SIHABIL';
					}
					else
			...
			echo"<td align=center>$idcita</td>
