...
?>
<form name="form1" method="POST" action="fac_4hegenerasiigoxls.php" target='fr02'>
<body lang=ES  style='tab-interval:35.4pt'>
<table class="Tbl0">
  <tr><td class="Td0" align='center'>TRASLADO A  S I I G O Formato XLS</td></tr>
</table>
...
<tr>
    ...
    <td class="Td2" align='left' width='25%'><input type='text' name='fechaini' size='10' maxlength='10' value='<?echo $fechaini;?>'>
...
<tr>
    ...
    <td class="Td2" align='left'><input type='text' name='fechafin' size='10' maxlength='10' value='<?echo $fechafin;?>'>
