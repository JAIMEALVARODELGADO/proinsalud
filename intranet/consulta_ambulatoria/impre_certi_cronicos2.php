<?php
	...
	*/
	...
	$ins=mysql_query("INSERT INTO proinsalud.certificado_cronicos (iden_certi,fecha_certi,hora_certi,nhisto_certi,funcio_certi)
	VALUES (NULL , '$fecha', '$hora', '$numhisto', '$codusu')");
	...
	$fila=$fila+$esp+$esp;
	$pdf->SetXY($izq,$fila);
	$pdf->MultiCell(160,6, "El suscrito medico de PROINSALUD S.A. Consulta Externa certifica que: el señor(a) ".$nombre." Identificado(a) con ".$tipo." No. ".$documento." de ".$ciudadexpe." una vez revisado su historia cl󺑣a presenta a la fecha los siguientes Diagn󳴩cos:", 0,J,0);
