...
//fin antimicrobianos	
	...
	else
	{
		...
		$inenca=mysql_query("insert into encabesadohistoria (numc_ehi,  nomb_ehi,  muat_ehi,  telf_ehi,  sexo_ehi,  fnac_ehi,  dire_ehi,  cont_ehi,  idus_ehi,  
		cous_ehi, feco_ehi, unid_ehi, origconsu_ehi, etni_ehi, nedu_ehi, ocup_ehi, eciv_ehi, grupopobla, orisexual ) 
...
//fin antimicrobianos	
			...
			//            $archivob='tmp/oft'.$codprograma.'-'.$Gcod_medico.'-'.$paciente.'.txt';
					...
					VALUES('$iden_consulta',  '$estfisico_ccl',  '$clafuncional_ccl',  '$aptociru_ccl',   '$anestesia_ccl', '$vario_ccl', '$anestesia1_ccl', '$reserva_ccl', '$reservauci_ccl',  '$premedica_ccl',  '$tprograma_ccl',   '$anotacion_ccl',   '$reevaluar_ccl',  '',  '$concent_ccl', '$numhisto', '$codigociru','$medicoproc_ccl')";
					//echo $sql_ins3.'<br><br>';
				...
				*/
					...
					{ 
						...
						if($reg % 8 == 0)
						{
							...
							if($id==0)
							{
								...
								$id=1;
								if($cantiexalab>0 && $Gcontratonh=="135" && $codGareanh!='04')
								{
									//Funcion para 
				...
				{			
					...
					{			
						...
						/*
						echo"<br>INSERT INTO `ingreso_hospitalario` ( `id_ing` , `codius_ing` , `fecin_ing` , `hora_ing` , `fecsa_ing` , `horsa_ing` , `consu_ing` , `ubica_ing` , `arerem_ing` , `cama_ing` , `contra_ing` , `caac_ing`) 
						VALUES ('0', '$paciente', '$fechafin', '$horafin', '0000-00-00', '00:00:00','04','$numhisto','04','','$cont', '01')";
						*/
						$idingre=mysql_insert_id();				
