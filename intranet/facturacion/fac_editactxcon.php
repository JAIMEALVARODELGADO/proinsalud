...
function validaelim(){
  if(confirm("Recuerde: Si la actividad ya est� facturada, no se eliminar�\nDesea eliminar las actividades seleccionadas")){
