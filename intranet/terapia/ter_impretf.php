...
$fil_=$pdf->GetY()+6;
$pdf->SetXY($col_,$fil_);
$pdf->Cell(125,5,utf8_decode("Impresión Diagnóstica: "),0,0,'L');
...
$col_=$col_+5;
$pdf->SetXY($col_,$fil_);
$pdf->cell(25,5,utf8_decode('Crioterápia'),0,0,'L');
...
$col_=110;
$pdf->SetXY($col_,$fil_);
$pdf->cell(65,5,utf8_decode('3. Estimulación Nerviosa Transcutánea: '),0,0,'L');
$col_=$col_+66;
$pdf->SetXY($col_,$fil_);
...
$col_=5;
$pdf->SetXY($col_,$fil_);
$pdf->Cell(125,5,utf8_decode("Técnicas Especiales: "),0,0,'L');
$fil_=$fil_+6;
$pdf->SetXY($col_,$fil_);
