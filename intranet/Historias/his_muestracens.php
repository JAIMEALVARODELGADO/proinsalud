...
<?php
	...
	echo "<th class=Estilo5>Cama</th><th class=Estilo5>Identificación</th><th class=Estilo5>Nombre</th><th class=Estilo5>Edad</th><th class=Estilo5>Contrato</th><th class=Estilo5>Ingreso</th><th class=Estilo5>Dias Estancia</th><th class=Estilo5>Diagnóstico</th><th class=Estilo5>Prefacturado</th>";
    if($area=='0634')
	{ $area='04';}
	//echo $area;
	 ...
	 while($row=mysql_fetch_array($_pagi_sql))
	{
		...
		echo "<td class='p1'>$ ".NUMBER_FORMAT($vprefac,0,",",".")."</td>";		
		echo "</tr>";
		$i++;
	...
	echo "</table>";
	echo "*si la columna Prefacturado esta en cero, significa que el paciente no tiene prefactura";
