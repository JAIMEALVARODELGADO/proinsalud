...
if($fila_>250){
	...
	$pdf_->Text($hor+140, $ver+29, 'CÓDIGO:');
	$pdf_->SetFont('Arial','',6);
	$pdf_->Text($hor+137, $ver+32, ' FRTER - 05');
	$pdf_->SetFont('Arial','B',6);
	$pdf_->Text($hor+140, $ver+36, 'VERSIÓN:');
	$pdf_->SetFont('Arial','',6);
	$pdf_->Text($hor+143, $ver+39, '00');
	$pdf_->SetFont('Arial','B',6);
	$pdf_->Text($hor+170, $ver+28.5, 'Fecha de elaboración:');
	$pdf_->SetFont('Arial','',6);
	$pdf_->Text($hor+168, $ver+30.5, '29 de Abril de 2011');
	$pdf_->SetFont('Arial','B',6);
	$pdf_->Text($hor+169, $ver+34, 'Fecha de actualización:');
	$pdf_->SetFont('Arial','',6);
