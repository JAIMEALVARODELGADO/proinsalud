...
var error="";
  ...
  /*if(validafecha(form1.feci_fac.value)==false){
    error+="Fecha de inicio del servicio inv�lida\n";
  }
  if(validafecha(form1.fecf_fac.value)==false){
    error+="Fecha final del servicio inv�lida\n";
  }
  ...
  if(error==""){
      if(validafechamen(form1.fecf_fac.value,form1.feci_fac.value)==true){
        error+="La fecha de inicio del servicio debe ser menor o igual a la de finalizaci�n\n";
      }
  }*/
  if(error!=""){
    alert("Para continuar debe corregir la siguiente informaci�n:\n"+error);}
  else{
	  ...
	  <table class='Tbl0' border='0'>
		...
		<tr>
			...
			<script type="text/javascript"> 
				...
				button       :    "lanzador0"     // el id del bot�n que lanzar� el calendario 
				});
			</script></button> </td>
			...
			<td class='Td2' align='right'><b>Nro Autorizaci�n:</td>
