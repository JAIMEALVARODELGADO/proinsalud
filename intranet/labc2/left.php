...
//base_general();
$consultausu=mysql_query("SELECT nomb_usua,tip_usuario FROM cut WHERE ide_usua='$Gidusulab'");
...
<div class="screenBody" id="">
  <form action="left.php" method="post" enctype="multipart/form-data" >
    <table id="navArea" cellspacing="0" cellpadding="0" width="100%" border="0" summary="Navigation Items Area">
      <?
        $consulta=mysql_query("SELECT codi_men,descr_men FROM menu WHERE aplic_men='37' and nivel_men=1");
                ...
                <div id="navLayout">
                  ...
                  <table border="0" cellspacing="0" cellpadding="0" width="100%" class="navOpened" id="<?echo $id;?>">
					...
					<?
					  ...
					  {
						$consultaopc=mysql_query("SELECT descr_men,url_men,img_men FROM menu AS m
                           INNER JOIN menuxusu AS mxu ON mxu.codi_men=m.codi_men AND mxu.ide_usua='$Gidusulab'
...
<table border="0" cellspacing="0"  width="100%" align=center  bgcolor='#D0D0F0'>
<tr>
<td align=center><font face="arial" size=1 color='#0B3861'><b>
<? echo 'BIENVENID@:<br>'.$nombreusu; ?></b></FONT></td>
</tr>
</table>
</body>
</html>