...
<form name="form1" method="POST" action="fac_2consulta.php" target='fr01'>
<body lang=ES  style='tab-interval:35.4pt'  >
<table class="Tbl0"><tr><td class="Td0" align='center'>FACTURACION - CONSULTAS</td></tr></table><br>
<?php 
	...
	<tr>
	  ...
	  <?php
		  //$consulta=mysql_query("SELECT codi_des,nomb_des FROM destipos WHERE codt_des='06' and homo2_des='F' order by nomb_des ");
            $consulta=mysql_query("SELECT cod_areas,nom_areas FROM areas WHERE facturar_area='S' order by nom_areas");
