...
<title>ADMINISTRACION DE ACCESO A RECURSOS</title>
</head>
	...
	<frameset rows="78,*" border=0 framespacing=0 frameborder=0 >
		...
		<frameset cols="210,*" border="0" frameborder="0" framespacing="0">
			...
			<frame src="principal.php" name="workFrame" frameborder="0" border="0" framespacing="0" marginheight="7" marginwidth="7" noresize scrolling="yes">
		</frameset>
