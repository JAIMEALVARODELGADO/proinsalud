...
<?php
	...
	if(!empty($gauditor)){
		...
		WHERE usuario.NROD_USU='$usu' AND usuario_auditor.ide_usua='$gauditor' AND ucontrato.ESTA_UCO='AC'";
	...
	$consulta="SELECT usuario.NROD_USU, contrato.CODI_CON, usuario.CODI_USU, usuario.PNOM_USU, usuario.SNOM_USU, usuario.PAPE_USU, usuario.SAPE_USU, usuario.FNAC_USU, usuario.SEXO_USU, usuario.TPAF_USU, usuario.MATE_USU, ucontrato.CONT_UCO, contrato.NEPS_CON, ucontrato.IDEN_UCO, usuario.MRES_USU
	...
	//echo $consulta;
	$resultusu=mysql_query($consulta);
