...
<?	
	...
	button     :    "lanzador1"     // el id del botÛn que lanzar· el calendario 				
	}); 
	</script> 				
	<?
	...
	ifFormat     :     "%Y-%m-%d",   // formato de la fecha que se escriba en el campo de texto 
	button     :    "lanzador2"     // el id del botÛn que lanzar· el calendario 				
	}); 
	</script> 				
	<?		
	echo"</td>		
...
function sanear_string($string)
{
    ...
    //Esta parte se encarga de eliminar cualquier caracter extraÒo
    $string = str_replace(
        array(chr(92), "®", "∫", "-", "~",
             "#", "@", "|", "!", chr(34),
