...
{	
	 ...
	 if($cedula=='12991944')
	 {
		 if($cedula!='')
		{
			...
			$bushisto=mysql_query("SELECT encabesadohistoria.idus_ehi, encabesadohistoria.cous_ehi, encabesadohistoria.numc_ehi, consultaprincipal.feca_cpl, consultaprincipal.hora_cpl, consultaprincipal.area_cpl, areas.nom_areas, medicos.nom_medi, consultaprincipal.codi_cpl, 
			consultaprincipal.come_cpl, consultaprincipal.inca_cpl
			FROM ((encabesadohistoria INNER JOIN consultaprincipal ON encabesadohistoria.numc_ehi = consultaprincipal.numc_cpl) INNER JOIN medicos ON consultaprincipal.come_cpl = medicos.cod_medi) INNER JOIN areas ON consultaprincipal.area_cpl = areas.cod_areas
			WHERE (((encabesadohistoria.cous_ehi)='$Gideusu'))
			...
			while($rhi=mysql_fetch_array($bushisto))
			{
				...
				echo"
				<tr>
				<td><a href='#' onclick='bushis(1, \"$nhisto\", \"$con\")'>$con - $nhisto</a></td>
				<td><a href='#' onclick='bushis(1, \"$nhisto\", \"$con\")'>$fecha</a></td>
				<td><a href='#' onclick='bushis(1, \"$nhisto\", \"$con\")'>$hora</a></td>
				<td><a href='#' onclick='bushis(1, \"$nhisto\", \"$con\")'>$medico</a></td>
				<td><a href='#' onclick='bushis(1, \"$nhisto\", \"$con\")'>$area</a></td>
				</tr>
				";
		...
		echo"<input type=hidden name=numhisto value='$numhisto'>";
