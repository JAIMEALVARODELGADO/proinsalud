...
<body onload='evaluar()'>
 ...
 <?
	...
	$consexa=mysql_query("SELECT encabezado_labs.iden_labs,encabezado_labs.cod_medi,encabezado_labs.nord_lab,encabezado_labs.codi_usu, encabezado_labs.fchr_labs, encabezado_labs.hrar_labs ,encabezado_labs.fche_labs, encabezado_labs.ambi_labs,encabezado_labs.codu_labs ,encabezado_labs.prog_labs, encabezado_labs.fina_labs
	FROM encabezado_labs 
	WHERE encabezado_labs.codi_usu=$codig_usu AND encabezado_labs.iden_labs=$iden_labs");
	
	while($rowex=mysql_fetch_array($consexa))
	{
		$fec=$rowex[fchr_labs];
		$nrd=$rowex[nord_lab];
		$amb_usu=$rowex[ambi_labs];
		$fin_con=$rowex[fina_labs];
		$condu=$rowex[codu_labs];
		$progu=$rowex[prog_labs];
		$hor=$rowex[hrar_labs];
		$med_soli=$rowex[cod_medi];
	}
	//echo $consexa;
	
	
	echo" <table class='Tbl0' >
	<tr><td class='Td1' align='center'><STRONG>INFORMACION DEL RIPS - $nrd</strong></td></tr>
	</table>";
    ...
    echo "<table class='Tbl0' border=0><tr>";?>
			...
			<?php echo "<input type=text name=fent id=fent size='10' value=$fec disabled>*";?>
			<input type="button" id="lanzador2" value="..." disabled />
			...
			<?echo"<span class=Estilo6>Hora: <input type=text name=mine size=6 value=$hor disabled></td>";?>
...
<?	
	...
	<td  width='35%'><input type=text name=amb_usu  size=2 maxlength=2  onBlur='verfin(this,opc_amb)' value='$amb_usu' disabled>";
	echo" <select name=opc_amb onchange='verfin(this,amb_usu)' disabled><option value=''></option>";
...
<?
	...
	<td  width='35%'><input type=text name=fin_con size=2 maxlength=2  onBlur='verfin(this,opc_fin)' value='$fin_con' disabled>";
	echo" <select name=opc_fin onchange='verfin(this,fin_con)' disabled><option value=''></option>";
...
<?
	...
	<td> <input type=text name=condu size=2 maxlength=2  onBlur='verfin(this,opc_condu)' value='$condu' disabled>";
	echo" <select name=opc_condu onchange='verfin(this,condu)' disabled><option value=''></option>";
...
<?
	...
	<td  width='35%'><input type=text name=progu size=2 maxlength=2  onBlur='verfin(this,opc_progu)' value='$progu' disabled>";
	echo" <select name=opc_progu onchange='verfin(this,progu)' disabled><option value=''></option>";
...
<?
	...
	echo "<td  width='40%'><input type=text name=med_soli size=10 maxlength=20  onBlur='verfin(this,opc_meds)' value='$med_soli' disabled>";
	echo" <select name=opc_meds onchange='verfin(this,med_soli)' disabled><option value=''></option>";
	...
	if($mcu>0)	
	{
		...
		echo"<td width='15%'><strong><input type=text name=refer ></td>";
		echo"</td></tr> ";
	}
	else
	{
...
/////////////////////////////////////////////////////-///////////////////////////////////////////////////////////////////
	...
	echo "<input type=hidden name=nord_lab value=$nrd>";
	?>
<br><br>
<table class='Tbl2'>
    <tr>
